...
SELECT employee_name, social_security_nums.ssn 
FROM employee
INNER JOIN social_security_nums
ON employee.id = social_security_nums.employee_id
...
INNER JOIN shift
ON employee.id = shift.employee_id
WHERE shift.start_time > '2024-01-01 08:00:00';
...
INNER JOIN shift
ON employee.id = shift.employee_id
WHERE shift.start_time BETWEEN '2024-02-01 08:00:00' AND '2024-03-07 13:00:00';
